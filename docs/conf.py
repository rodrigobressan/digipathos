...
# -*- coding: utf-8 -*-
#
# Entity Embeddings Categorical documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'Digipathos.tex', 'Digipathos Documentation',
     'Rodrigo Bresan', 'manual'),
]
...
man_pages = [
    (master_doc, 'digipathos', 'Digipathos Documentation',
     [author], 1)
]
